...
namespace SocketIOClient.Routers
{
    public class WebSocketRouter : Router
    {
        ...
        public WebSocketRouter(ILoggerFactory loggerFactory, HttpClient httpClient, Func<IClientWebSocket> clientWebSocketProvider, SocketIOOptions options) : base(loggerFactory.CreateLogger<WebSocketRouter>(), httpClient, clientWebSocketProvider, options)
        {
        ...
        public override async Task ConnectAsync()
        {
            ...
            _webSocketTransport = new WebSocketTransport(_loggerFactory.CreateLogger<WebSocketTransport>(), _clientWebSocket, EIO)
            {
            ...
            _logger.LogDebug($"[Websocket] Connecting");
