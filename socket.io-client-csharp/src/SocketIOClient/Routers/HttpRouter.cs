...
namespace SocketIOClient.Routers
{
    public class HttpRouter : Router
    {
        ...
        public HttpRouter(ILogger<HttpRouter> logger, HttpClient httpClient, Func<IClientWebSocket> clientWebSocketProvider, SocketIOOptions options) : base(logger, httpClient, clientWebSocketProvider, options)
        {
        }
