...
namespace SocketIOClient.Transport
{
    ...
    {
        public DefaultClientWebSocket(string token)
        {
            _ws = new ClientWebSocket();
            if (token is not null)
            {
                _ws.Options.Cookies.Add(new Cookie("pu-sid", token, "/", ".prosperousuniverse.com"));
                _ws.Options.Cookies.Add(
                    new Cookie("_sl_ref", "https%3A%2F%2Fprosperousuniverse.com%2F", "/", ".prosperousuniverse.com"));
            }
